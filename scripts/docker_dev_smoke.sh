...
url = "http://127.0.0.1:${DEV_PORT}/web/login"
try:
    ...
    print(f"DOCKER_DEV_SMOKE_FAILED customer_web_login url={url} error={exc}", file=sys.stderr)
    sys.exit(1)
print(f"DOCKER_DEV_SMOKE_OK customer_web_login url={url}")
PY
